...
python get_activations.py --run_id $vp_id --exp_type $folder_name --source art clipart realworld --target product --dataset OfficeHome --generate_for product --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vp_id --exp_type $folder_name --source art clipart realworld --target product --dataset OfficeHome --generate_for art --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vp_id --exp_type $folder_name --source art clipart realworld --target product --dataset OfficeHome --generate_for clipart --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vp_id --exp_type $folder_name --source art clipart realworld --target product --dataset OfficeHome --generate_for realworld --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222
...
python get_activations.py --run_id $va_id --exp_type $folder_name --source product clipart realworld --target art --dataset OfficeHome --generate_for product --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $va_id --exp_type $folder_name --source product clipart realworld --target art --dataset OfficeHome --generate_for art --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $va_id --exp_type $folder_name --source product clipart realworld --target art --dataset OfficeHome --generate_for clipart --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $va_id --exp_type $folder_name --source product clipart realworld --target art --dataset OfficeHome --generate_for realworld --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222
...
python get_activations.py --run_id $vc_id --exp_type $folder_name --source product art realworld --target clipart --dataset OfficeHome --generate_for product --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vc_id --exp_type $folder_name --source product art realworld --target clipart --dataset OfficeHome --generate_for art --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vc_id --exp_type $folder_name --source product art realworld --target clipart --dataset OfficeHome --generate_for clipart --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vc_id --exp_type $folder_name --source product art realworld --target clipart --dataset OfficeHome --generate_for realworld --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222
...
python get_activations.py --run_id $vr_id --exp_type $folder_name --source product art clipart --target realworld --dataset OfficeHome --generate_for product --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vr_id --exp_type $folder_name --source product art clipart --target realworld --dataset OfficeHome --generate_for art --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vr_id --exp_type $folder_name --source product art clipart --target realworld --dataset OfficeHome --generate_for clipart --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

python get_activations.py --run_id $vr_id --exp_type $folder_name --source product art clipart --target realworld --dataset OfficeHome --generate_for realworld --batch_size 128 --n_classes 65 --network resnet18 --jigsaw_n_classes 30 --image_size 222

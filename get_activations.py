...
class Trainer:
    ...
    def get_features(self):
        ...
        with open(osp.join('logs', self.exp_type, 'act_labels_{}_layer_{}.pkl'.format(self.args.target,self.freeze_layer)), 'wb') as handle:
          pickle.dump(target_data, handle, protocol=pickle.HIGHEST_PROTOCOL)

        print("Activations saved to logs/{}/act_labels_{}_layer_{}.pkl".format(self.exp_type, self.args.target,self.freeze_layer))
